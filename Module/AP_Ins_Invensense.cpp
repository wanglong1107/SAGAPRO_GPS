...
//        rotate_and_correct_accel(_accel_instance, accel);
//        rotate_and_correct_gyro(_gyro_instance, gyro);

//        notify_new_accel_raw_sample(_accel_instance, accel, 0, fsync_set);
//        notify_new_gyro_raw_sample(_gyro_instance, gyro);
 ...
 */
bool AP_Ins_Invensense::accumulate_sensor_rate_sampling(uint8_t *samples, uint8_t n_samples)
{
    int32_t tsum = 0;
