...
protected:
    ...
    int8_t _type[GPS_MAX_RECEIVERS];
    int8_t _navfilter;
    int8_t _auto_switch;
    int8_t _min_dgps;
    ...
    int8_t _raw_data;
    int8_t _gnss_mode[GPS_MAX_RECEIVERS];
    int16_t _rate_ms[GPS_MAX_RECEIVERS];   // this parameter should always be accessed using get_rate_ms()
    int8_t _save_config;
    int8_t _auto_config;
    Vector3f _antenna_offset[GPS_MAX_RECEIVERS];
    int16_t _delay_ms[GPS_MAX_RECEIVERS];
    int8_t _blend_mask;
    float _blend_tc;
