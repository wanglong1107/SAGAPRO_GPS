											  ...
											  enum Rotation rotation)
{
    ...
    AP_Compass_QMC5883L *sensor = new AP_Compass_QMC5883L(compass, static_cast<AP_HAL::Device *>(dev),force_external,rotation);
...
//    _dev->get_semaphore()->give();
    ...
    //Enable 100HZ
//    _dev->register_periodic_callback(10000, FUNCTOR_BIND_MEMBER(&AP_Compass_QMC5883L::timer, void));
...
void AP_Compass_QMC5883L::timer()
{
    ...
    auto x = -static_cast<int16_t>(buffer.rx);
    auto y = static_cast<int16_t>(buffer.ry);
    auto z = -static_cast<int16_t>(buffer.rz);
...
//#endif
    ...
    if (1) //_sem->take(HAL_SEMAPHORE_BLOCK_FOREVER)
	{
        _accum += field;
        _accum_count++;
        if(_accum_count == 20)
