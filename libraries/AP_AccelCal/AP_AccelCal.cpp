...
void AP_AccelCal::start()//void AP_AccelCal::start(GCS_MAVLINK *gcs)
{
...
void AP_AccelCal::handleMessage()//void AP_AccelCal::handleMessage(const mavlink_message_t* msg)
{
