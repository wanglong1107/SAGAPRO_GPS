...
private:
    ...
    int8_t  _enable;               // zero to disable EKF2
    ...
    int16_t _gpsDelay_ms;          // effective average delay of GPS measurements relative to inertial measurement (msec)
    ...
    int8_t _imuMask;               // Bitmask of IMUs to instantiate EKF2 for
